...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',min=0, max=10000, step=1000,
                                                marks={0: '0',  100: '100',200:'200',1000:'10000',5000:'5000',
                                                10000:'10000'},
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        names='Launch Site', 
        title='Sucess Rate per launch site')
        return fig
    elif entered_site=='CCAFS LC-40':
        fig = px.pie(filtered_df[filtered_df['Launch Site'] == 'CCAFS LC-40'], values='class', 
        names='class', 
        title='Sucess Rate for CCAFS LC-40')
        return fig
    elif entered_site=='VAFB SLC-4E':
        fig = px.pie(filtered_df[filtered_df['Launch Site'] == 'VAFB SLC-4E'], values='class', 
        names='class', 
        title='Sucess Rate for VAFB SLC-4E')
        return fig
    elif entered_site=='KSC LC-39A':
        fig = px.pie(filtered_df[filtered_df['Launch Site'] == 'KSC LC-39A'], values='class', 
        names='class', 
        title='Sucess Rate for KSC LC-39A')
        return fig
    elif entered_site=='CCAFS SLC-40':
        fig = px.pie(filtered_df[filtered_df['Launch Site'] == 'CCAFS SLC-40'], values='class', 
        names='class', 
        title='Sucess Rate for CCAFS SLC-40')
        return fig
    else:
        fig = 'img err'
        return fig
